...
class TextFieldView: UIView {
    ...
    var pickerDetailComponents: [Detail]?
    ...
    private func stylizeViews() {
        ...
        descriptionTextView.tintColor = AppData.Color.technolygedBlackGray.uiColor
    ...
    func set(inputType: TextFieldCellInputType) {
        ...
        case .picker(let components, let row):
            ...
            pickerView.tintColor = AppData.Color.proactiveGreen.uiColor
        ...
        case .datePicker:
            ...
            datePicker.tintColor = AppData.Color.proactiveGreen.uiColor
