...
class AuthFactor: Mappable {
    var type: Constants.AuthFactorType?
...
final class AuthorizationAdapter {
    ...
    /// Shared instance of **AuthorizationAdapter** class
    public static let shared = AuthorizationAdapter()
    
    /// Private initializer
    private init() {}
    public var customers: [Customer]?
    public var authFactorResponse: AuthFactorResponse?
    public var authFactors: [[Constants.FactorsType]]?
    public var customerPersonId: Int?
    public var lastAuthFactor: String?
    public var canSkip: Bool?
    public var encryptedLogin: String?
    public var encryptedPassword: String?
}

import ObjectMapper

class AuthFactorResponse: Mappable {
    var step: Int?
