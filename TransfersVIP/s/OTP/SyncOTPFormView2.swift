...
class SyncOTPFormView: CodeLikeAuthFactorFormView {
    ...
    override func stylize() {
        ...
        secondCodeTextField.font = AppData.Font.cignikaRegular.uiFont
    ...
    override func setupConstraints() {
        ...
        secondCodeTextField.heightAnchor.constraint(equalToConstant: 48).isActive = true
    }
