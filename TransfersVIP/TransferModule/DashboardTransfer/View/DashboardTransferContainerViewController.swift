...
class DashboardTransferContainerViewController: UIViewController {
    ...
    private func setPageController(viewControllers: [TransferPagesProtocol]) {
    ...
    private func initilizeTransferChildViewControllers() {
        ...
        guard let viewControllers = [
            ...
            ] as? [TransferPagesProtocol] else { return }
...
extension DashboardTransferContainerViewController: UIPageViewControllerDelegate {
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        guard finished, let currentPageController = pageViewController.viewControllers?.last as? TransferPagesProtocol else {
            return
        }
...
extension DashboardTransferContainerViewController: UIPageViewControllerDataSource {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        guard let currentVC = viewController as? TransferPagesProtocol else {
            return nil
        }
...
class TemplateViewController: UIViewController, TransferPagesProtocol {
...
class RegularViewController: UIViewController, TransferPagesProtocol {
...
protocol TransferPagesProtocol where Self: UIViewController {
    var page: Pages { get }
}
